@{
    ...
    AliasesToExport = @('XmlAttribute','XmlComment','XmlDocument','XmlElement','XmlNamespace','XmlText');
    FunctionsToExport = @('Add-XmlExAttribute','Add-XmlExComment','Add-XmlExElement','Add-XmlExNamespace','Add-XmlExText','Format-XmlEx','New-XmlExDocument');
    PrivateData = @{
